...
const S = {
  card:        'bg-[#3a3a40] rounded-2xl p-5 sm:p-8 border border-[#4a4a52]/60',
  secIcon:     'w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0',
  fieldLabel:  'text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-1',
  selectBase:  'w-full h-12 pl-5 pr-10 bg-black/40 border border-[#4a4a52] rounded-xl text-[#f1f5f9] font-medium text-sm cursor-pointer appearance-none outline-none transition-colors focus:border-orange-500/50',
  inputBase:   'w-full h-12 px-5 bg-black/40 border border-[#4a4a52] rounded-xl text-[#f1f5f9] font-medium text-sm outline-none transition-colors focus:border-orange-500/50 placeholder:text-slate-500',
  toolBtn:     'flex items-center gap-4 px-5 py-4 bg-black/40 border border-[#4a4a52] rounded-xl transition-all hover:bg-[#4a4a52]/60 hover:border-orange-500/30 active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#2a2a2e] w-full text-left',
  historyItem: 'flex items-center gap-4 p-4 bg-black/40 border border-[#4a4a52] rounded-xl hover:bg-[#323237] hover:border-orange-500/25 transition-all text-left focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#2a2a2e] w-full',
};
...
const SectionHead: React.FC<{
  ...
  <div className="flex items-center gap-3 mb-6 overflow-hidden">
    ...
    <span
      className="font-bold text-[#f1f5f9] flex-shrink-0 tracking-wide"
      style={{ ...body, fontSize: 'clamp(14px, 3.5vw, 16px)', textTransform: 'uppercase' }}
    >
      {title}
    </span>
    <div className="flex-1 h-px bg-[#4a4a52] min-w-0" />
...
const ChevronDown = () => (
  <svg className="w-4 h-4 text-slate-400 pointer-events-none absolute right-4 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="max-w-lg md:max-w-4xl mx-auto px-3 sm:px-4 pb-20 space-y-4 sm:space-y-5">
      ...
      {showTireTips && (
        <div className="fixed inset-0 z-[90] bg-black/80 flex items-center justify-center p-4">
          <div className="bg-[#3a3a40] border border-[#4a4a52] rounded-2xl p-6 max-w-sm w-full shadow-2xl">
            <h3 className="text-[#f1f5f9] font-bold text-lg mb-1" style={body}>Tips for a good scan</h3>
            <p className="text-slate-400 text-xs mb-5" style={body}>Better photos = more accurate results.</p>
            <ul className="space-y-3 mb-6">
              {[
                ...
                <li key={title} className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-slate-400" style={body}><span className="font-semibold text-[#f1f5f9]">{title}:</span> {tip}</span>
                </li>
              ))}
            </ul>
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-3 bg-black/30 border border-[#4a4a52] text-slate-400 rounded-xl text-sm font-semibold"
                style={body}
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-orange-500 to-red-600 text-[#f1f5f9] rounded-xl text-sm font-bold"
                style={body}
              >
                Got it — scan now
              </button>
        ...
        <div className="flex flex-col gap-2">
          <button type="button" aria-label="Scan tire tread" onClick={() => setShowTireTips(true)} className={S.toolBtn}>
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-semibold text-[#f1f5f9]" style={body}>Tire Tread Scan</div>
              <div className="text-xs text-slate-400 mt-0.5" style={body}>Upload or photograph your tire for a wear analysis</div>
            </div>
            <ChevronRight />
          </button>
          ...
          <button type="button" aria-label="Find local mechanic" onClick={() => onFindServices('mechanic')} className={S.toolBtn}>
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-semibold text-[#f1f5f9]" style={body}>Find a Mechanic</div>
              <div className="text-xs text-slate-400 mt-0.5" style={body}>Nearby rated shops based on your location</div>
            </div>
            <ChevronRight />
          </button>
          ...
          <button type="button" aria-label="Request towing service" onClick={() => onFindServices('towing')} className={S.toolBtn}>
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-semibold text-[#f1f5f9]" style={body}>Request Towing</div>
              <div className="text-xs text-slate-400 mt-0.5" style={body}>Find tow services dispatched to your location</div>
            </div>
            <ChevronRight />
          </button>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
        ...
        {step === 1 && <section className={S.card}>
          ...
          {manualEntry ? (
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-400 pl-1" style={body}>
                Vehicle not listed?{' '}
        ...
        <section className={S.card}>
            ...
            right={
              <div className="relative">
                ...
                <button
                  ...
                  className={`relative flex items-center gap-2 px-3 py-2 rounded-xl border-b-2 font-semibold text-xs transition-all focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#2a2a2e] whitespace-nowrap
                    ${isRecording
                      ? 'bg-orange-600 border-orange-800 text-[#f1f5f9]'
                      : isConnecting
                      ? 'bg-[#4a4a52] border-[#2a2a2e] text-slate-400'
                      : 'bg-black/40 border-[#4a4a52] text-slate-400 hover:border-orange-500/40 hover:text-[#f1f5f9]'
                    }`}
                  style={body}
                >
                  {isRecording ? (
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-3 right-4 text-[10px] text-slate-400" style={body}>
                  {charCount} chars
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1">
                {[
                  ...
                  <div key={label} className="flex items-start gap-2 bg-black/30 border border-[#4a4a52]/60 rounded-xl px-3 py-2.5 min-h-[52px]">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400 leading-snug" style={body}>{hint}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full h-12 flex items-center justify-center gap-2 px-5 bg-black/40 border-2 border-dashed border-[#4a4a52] rounded-xl text-slate-400 hover:border-orange-500/30 hover:text-slate-400 transition-all focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#2a2a2e] text-sm font-medium"
                  style={body}
                >
          ...
          {files.length > 0 && (
            <div className="mt-5 pt-5 border-t border-[#4a4a52]/60">
              <p className="text-xs font-semibold text-slate-400 mb-3" style={body}>
                Attachments ({files.length})
              </p>
              <div className="flex flex-wrap gap-3">
                {files.map((file, idx) => (
                  <div key={idx} className="relative group w-16 h-16 rounded-xl overflow-hidden border border-[#4a4a52] bg-[#323237] flex items-center justify-center">
                    {file.type === 'image' ? (
                      <img src={file.data} className="w-full h-full object-cover" alt={file.name} />
                    ) : (
                      <div className="w-full h-full flex items-center justify-center bg-[#4a4a52]">
                    ...
                    <button
                      ...
                      className="absolute top-1 right-1 bg-red-600 text-[#f1f5f9] rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity"
                    >
        ...
        <button
          type="submit"
          disabled={isLoading}
          className={`not-italic w-full py-3 rounded-xl flex items-center justify-center gap-3 transition-all focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#2a2a2e]
            ${isLoading
              ? 'bg-[#4a4a52] text-slate-400 cursor-not-allowed'
              : 'bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-400 hover:to-red-500 text-[#f1f5f9] shadow-lg shadow-orange-500/20 hover:-translate-y-0.5 active:scale-[0.99]'
            }`}
          ...
          <SectionHead
            ...
            right={
              <button
                ...
                className="text-xs font-medium text-slate-400 hover:text-red-400 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 rounded px-1"
                style={body}
              >
                Clear all
              </button>
            ...
            {history.map(item => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="font-semibold text-[#f1f5f9] text-sm truncate" style={body}>
                  ...
                  <div className="text-xs text-slate-400 mt-0.5" style={body}>
