        ...
        {error ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8 text-center">
            ...
            <button
              ...
              className="px-8 py-3 bg-orange-600 text-white rounded-xl font-black uppercase tracking-widest text-sm mb-3"
            >
              Upload from Gallery
            </button>
            <button
              onClick={onClose}
              className="px-8 py-3 bg-white/10 text-white rounded-xl font-black uppercase tracking-widest text-sm"
            >
              Go Back
            </button>
          </div>
